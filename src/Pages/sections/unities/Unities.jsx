...
const Unities = () => {
    ...
    return (
        <div 
            id="unities" 
            /* AQUI ESTÁ A MÁGICA:
               - hidden: Oculta o elemento em telas pequenas (mobile first).
               - lg:flex: Torna o elemento visível (flexbox) apenas em telas grandes (Desktop).
            */
            className="hidden lg:flex bg-black text-white h-screen py-10 px-4 flex-col items-center justify-center relative overflow-hidden"
        >
            <h2 className="text-4xl font-bold mb-20 absolute top-20 text-[#FCAE2D] tracking-wide uppercase">
                Nossas Unidades
            </h2>
            ...
            <div className="flex items-center gap-8 xl:gap-16">
                <button
                    onClick={previous}
                    className="text-[#FCAE2D] hover:text-white hover:scale-110 transition-all duration-300 z-20"
                >
