...
const ModalSecretary = ({ member, onClose, onShowInfo }) => {
			...
			<div className="bg-white rounded-lg w-[900px] h-[540px] shadow-lg relative p-8 flex flex-col justify-between">
				...
				<div className="flex flex-1 items-center justify-between space-x-10 mt-6">
					<div className="flex flex-col space-y-4 w-1/2">
						...
						<InputField label="Aniversário" icon={<FaUser />} value={member.birthday} />
					...
					<div className="flex flex-col space-y-4 w-1/2">
						<div className="w-full h-40 rounded bg-gray-50 flex items-center justify-center border">
							<svg xmlns="http://www.w3.org/2000/svg" className="w-24 h-24 text-blue-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
								<path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 12c2.485 0 4.5-2.015 4.5-4.5S14.485 3 12 3 7.5 5.015 7.5 7.5 9.515 12 12 12zM6.75 21a7.5 7.5 0 0110.5 0" />
							</svg>
						</div>
				...
				<div className="mt-4 w-full text-right">
					<button
						onClick={onShowInfo} 
						className="text-blue-900 font-semibold items-center space-x-1 cursor-pointer inline-flex justify-end"
					>
						<span>Ver informações completas</span>
						<span className="ml-1 w-5 h-5 rounded-full border border-blue-900 text-blue-900 flex items-center justify-center text-xs font-bold">
							+
						</span>
					</button>
				</div>
