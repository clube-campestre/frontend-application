				...
				<div className="flex flex-1 items-center justify-between space-x-10 mt-6">
					...
					<div className="flex flex-col space-y-4 w-1/2">
						...
						<InputField
							...
							icon={<FaPhoneAlt />}
							value={member.fatherPhone}
						/>
						<InputField
							label="Telefone da mãe"
							icon={<FaPhoneAlt />}
							value={member.motherPhone}
						/>
					</div>
				</div>

				<div className="mt-4 w-full text-right">
					<button className="text-blue-900 font-semibold items-center space-x-1 cursor-pointer inline-flex justify-end">
