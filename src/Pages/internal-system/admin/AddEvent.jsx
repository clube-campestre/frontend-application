...
const AddEvent = () => {
  ...
  return (
    <div className="bg-gray-100 rounded-lg p-6 shadow-md max-w-4xl mx-auto">
      <div className="mb-6">
        <h2 className="text-xl font-semibold text-gray-800">Cadastrar evento</h2>
      ...
      <div className="flex flex-wrap -mx-2">
        <div className="w-1/2 px-2 mb-4">
          ...
          <div className="mt-4">
            <label className="block text-sm font-medium text-gray-700 mb-1">
              anexe um arquivo <span className="text-gray-400 text-xs">(opcional)</span>
            </label>
              ...
              >
                ...
                <span className="ml-2 text-[#FCAE2D]">
                  <svg width="16" height="20" viewBox="0 0 16 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M2 0C0.9 0 0 0.9 0 2V18C0 19.1 0.9 20 2 20H14C15.1 20 16 19.1 16 18V6L10 0H2Z" fill="#FCAE2D"/>
                  </svg>
                </span>
              </button>
            </div>
        ...
        <div className="w-1/2 px-2 mb-4">
          ...
          >
            ...
            {imagem ? (
              ...
              <>
                <p className="text-sm text-gray-500 mb-2">Arraste ou selecione</p>
                <p className="text-sm text-gray-500">a imagem aqui</p>
                <svg className="mt-2" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M14 2H6C4.9 2 4 2.9 4 4V20C4 21.1 4.9 22 6 22H18C19.1 22 20 21.1 20 20V8L14 2Z" stroke="#FCAE2D" strokeWidth="2"/>
                </svg>
              </>
            )}
          </div>
